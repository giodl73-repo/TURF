...
| Northlake | 6 | 4 | `finance_car_trip_health_trade_wellness_legacy_mall_field` |
...
- Camp Creek: finance/car-trip/wellness airport-edge field in the current
  checked layers.
- Northlake: finance/car-trip/health/trade/wellness legacy mall field.

The dollar-store layer is source-gated in every Atlanta field. The hardware
layer adds checked Buckhead and Northlake small-trade rows, checks Camp Creek
and Decatur absent, and is source-gated in the other three fields. The
laundromat layer adds dense Cumberland household-service signal, checks
Perimeter and North Point absent, and source-gates four fields.
...
and pharmacy are checked absent. Northlake now has library, bank,
gas/convenience, pharmacy, hardware, and gym signal, and has moved into a
usable comparison tier even though dollar-store, laundromat, park/open-space,
and transit remain gated.
...
civic/open-space/small-trade mall, finance/household/wellness,
finance/car-trip/wellness airport-edge, finance/car-trip/health
service-village, and finance/car-trip/health/trade/wellness legacy-mall
patterns.
