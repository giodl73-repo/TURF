...
| Northlake | 0 | 4 | `fully_source_gated_civic_field` |
...
Camp Creek and Northlake are not civic blanks. They are fully source-gated in
the current civic pass and need another source strategy or later Overpass retry.
