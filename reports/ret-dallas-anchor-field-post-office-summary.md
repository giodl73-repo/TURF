...
| Las Colinas / Irving | 3 | 1 | `observed` |  |
...
Las Colinas / Irving resolved on a targeted retry. Carl Range Post Office,
Irving Post Office - Central Station, and Irving Post Office - Las Colinas
Station are packet-ready rows. Eagle Postal Center remains visible but excluded
as a private postal counter.

Arlington / Grand Prairie and Fort Worth Cultural / West 7th remain
source-gated because their target requests timed out. Those timeouts should be
retried or moved to an alternate public source path before TURF uses postal
signal to rank those fields.
