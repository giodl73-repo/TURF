...
The Los Angeles / Inland Empire retail-complex anchor-field readout is:
...
The Philadelphia / South Jersey anchor-field pharmacy readout is:
...
The Dallas/Fort Worth auto-parts sidecar layer is:
`reports\ret-dallas-anchor-field-auto-parts-summary.md`.

The Dallas/Fort Worth QSR / auto-parts comparison is:
...
The Dallas/Fort Worth anchor-field mass-retail readout is:
...
The Atlanta Northlake service source-resolution pass is:
