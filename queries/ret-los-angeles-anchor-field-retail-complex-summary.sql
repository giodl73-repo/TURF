...
--
-- Uses reviewed California retail-complex rows to confirm mall, power-center,
-- lifestyle-center, plaza, and shopping-center anchors after grocery, mass
-- retail, and pharmacy layers.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-los-angeles-anchor-field-retail-complex-summary.csv'
  (HEADER, DELIMITER ',');
