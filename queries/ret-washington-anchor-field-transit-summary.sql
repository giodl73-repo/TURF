-- Washington anchor-field transit-center summary.
...
COPY (
    SELECT
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS transit_center_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-transit-summary.csv'
  (HEADER, DELIMITER ',');
