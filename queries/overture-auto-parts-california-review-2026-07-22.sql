-- Conservative review layer for California auto-parts rows.
--
...
COPY (
    WITH raw_rows AS (
        ...
        FROM read_csv_auto('fixtures/stores/overture-auto-parts-california-2026-07-22.csv', all_varchar = true)
    )
    SELECT
        brand,
        store_id,
...
) TO 'fixtures/stores/overture-auto-parts-california-review-2026-07-22.csv'
  (HEADER, DELIMITER ',');
