-- Washington anchor-field gas/convenience summary.
...
COPY (
    SELECT
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS gas_convenience_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-gas-convenience-summary.csv'
  (HEADER, DELIMITER ',');
