-- Washington anchor-field laundromat summary.
...
COPY (
    SELECT
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS laundromat_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-laundromat-summary.csv'
  (HEADER, DELIMITER ',');
