...
COPY (
    SELECT
        ...
        max(CASE WHEN dimension_id = 'dollar_store' THEN observed_rows ELSE NULL END) AS dollar_store_rows,
        max(CASE WHEN dimension_id = 'dollar_store' THEN observed_brands ELSE NULL END) AS dollar_store_brands,
        max(CASE WHEN dimension_id = 'dollar_store' THEN observed_names ELSE '' END) AS dollar_store_names,
        ...
        max(CASE WHEN dimension_id = 'gym' THEN observed_rows ELSE NULL END) AS gym_rows,
        max(CASE WHEN dimension_id = 'gym' THEN observed_brands ELSE NULL END) AS gym_brands,
        max(CASE WHEN dimension_id = 'gym' THEN observed_names ELSE '' END) AS gym_names,
        ...
        max(CASE WHEN dimension_id = 'laundromat' THEN observed_rows ELSE NULL END) AS laundromat_rows,
        max(CASE WHEN dimension_id = 'laundromat' THEN observed_brands ELSE NULL END) AS laundromat_brands,
        max(CASE WHEN dimension_id = 'laundromat' THEN observed_names ELSE '' END) AS laundromat_names,
