-- Conservative review layer for Pennsylvania / New Jersey mass-retail rows.
--
...
) TO 'fixtures/stores/overture-mass-retail-pennsylvania-new-jersey-review-2026-07-22.csv'
  (HEADER, DELIMITER ',');
