-- Washington anchor-field post-office summary.
...
COPY (
    SELECT
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS post_office_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-post-office-summary.csv'
  (HEADER, DELIMITER ',');
