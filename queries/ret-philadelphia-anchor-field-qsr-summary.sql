...
--
-- Uses the reviewed Pennsylvania / New Jersey McDonald's / Burger King /
-- Wendy's / Taco Bell layer to test daily-trip and corridor signal across the
-- existing Philadelphia / South Jersey anchor-field boxes.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-philadelphia-anchor-field-qsr-summary.csv'
  (HEADER, DELIMITER ',');
