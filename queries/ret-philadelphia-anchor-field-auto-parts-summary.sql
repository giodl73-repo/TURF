...
--
-- Uses the reviewed Pennsylvania / New Jersey AutoZone / O'Reilly / NAPA /
-- Advance Auto Parts layer to test trade and car-service corridor signal
-- across the same bounded Philadelphia / South Jersey fields.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-philadelphia-anchor-field-auto-parts-summary.csv'
  (HEADER, DELIMITER ',');
