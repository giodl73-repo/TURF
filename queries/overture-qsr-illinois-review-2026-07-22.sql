-- Conservative review layer for Illinois QSR rows.
--
...
COPY (
    WITH raw_rows AS (
        ...
        FROM read_csv_auto('fixtures/stores/overture-qsr-illinois-2026-07-22.csv', all_varchar = true)
    )
    SELECT
        brand,
        store_id,
...
) TO 'fixtures/stores/overture-qsr-illinois-review-2026-07-22.csv'
  (HEADER, DELIMITER ',');
