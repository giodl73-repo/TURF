...
--
-- Pharmacy uses the reviewed California drugstore layer as a health-errand
-- proxy, intersected with bounded LA / Inland Empire target fields.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-los-angeles-anchor-field-pharmacy-summary.csv'
  (HEADER, DELIMITER ',');
