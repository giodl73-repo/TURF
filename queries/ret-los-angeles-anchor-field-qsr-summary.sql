...
--
-- Uses the reviewed California McDonald's / Burger King / Wendy's / Taco Bell
-- layer to test daily-trip and corridor signal across the same bounded LA
-- fields.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-los-angeles-anchor-field-qsr-summary.csv'
  (HEADER, DELIMITER ',');
