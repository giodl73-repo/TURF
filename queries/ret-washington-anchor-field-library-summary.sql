-- Washington anchor-field library summary.
...
COPY (
    SELECT
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS library_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-library-summary.csv'
  (HEADER, DELIMITER ',');
