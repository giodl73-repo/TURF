...
COPY (
    SELECT
        ...
        anchor_field,
        count(*) AS bank_credit_union_rows,
        ...
        string_agg(facility_name, '; ' ORDER BY facility_name) AS bank_credit_union_names
    FROM read_csv_auto(
    ...
    ORDER BY
        CASE target_id
            ...
            ELSE 99
        END
) TO 'reports/ret-washington-anchor-field-bank-credit-union-summary.csv'
  (HEADER, DELIMITER ',');
