-- Conservative review layer for Pennsylvania / New Jersey QSR rows.
--
...
COPY (
    WITH raw_rows AS (
        ...
        FROM read_csv_auto('fixtures/stores/overture-qsr-pennsylvania-new-jersey-2026-07-22.csv', all_varchar = true)
    )
    SELECT
        brand,
        store_id,
...
) TO 'fixtures/stores/overture-qsr-pennsylvania-new-jersey-review-2026-07-22.csv'
  (HEADER, DELIMITER ',');
