...
--
-- Uses the reviewed Illinois AutoZone / O'Reilly / NAPA / Advance Auto Parts
-- layer to test trade and car-service corridor signal across the existing
-- Chicago anchor-field boxes.
...
COPY (
    ...
    ORDER BY
        CASE field_id
            ...
            ELSE 99
        END
) TO 'reports/ret-chicago-anchor-field-auto-parts-summary.csv'
  (HEADER, DELIMITER ',');
