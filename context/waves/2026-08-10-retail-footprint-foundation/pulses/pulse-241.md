# Pulse 241: Minimum Postal Parish Clayville Truth Dossier

## Summary

Added the first candidate truth dossier for Clayville RI and connected the
dossier decision back into the five-candidate dossier index.

## Files

- `research/tracks/A-lineage/A.1b+minimum-postal-parish/sections/64-clayville-truth-dossier.md`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/clayville-truth-dossier-source-review-2026-08-16.csv`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/clayville-truth-dossier-decision-2026-08-16.csv`
...
`not_yet_truth_dossier_reviewed=4` and
`provisional_target_box_survivor_with_operations_gate=1`.

Clayville remains a target-box survivor, but it is not promotable to confirmed
exemplar because the dossier carries a postal operations-status gate and nearby
North Scituate services weaken any broader isolation interpretation.

## Boundary

The pulse reviews Clayville only. It does not change the bounded denominator,
promote a confirmed exemplar, or support regional, stratum, or national
frequency claims.
