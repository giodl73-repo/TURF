# Pulse 244: Minimum Postal Parish Carpenter Truth Dossier

## Summary

Added the Carpenter WY truth dossier and connected its decision back into the
five-candidate dossier index.

## Files

- `research/tracks/A-lineage/A.1b+minimum-postal-parish/sections/67-carpenter-truth-dossier.md`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/carpenter-truth-dossier-source-review-2026-08-16.csv`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/carpenter-truth-dossier-decision-2026-08-16.csv`
...
`not_yet_truth_dossier_reviewed=1`,
`provisional_target_box_survivor_with_operations_gate=1`,
`strict_target_box_survivor_no_nearby_service_observed=1`, and
`strict_target_box_survivor_with_nearby_service_constraint=2`.

Carpenter remains a strict sampled target-box survivor, but Antelope Truck Stop
and TA Cheyenne are outside-box nearby services and must be carried as a
constraint on any narrative use.

## Boundary

The pulse reviews Carpenter only. It does not prove complete service absence,
catchment isolation, or regional, stratum, or national frequency.
