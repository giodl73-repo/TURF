# Pulse 243: Minimum Postal Parish Alum Bridge Truth Dossier

## Summary

Added the Alum Bridge WV truth dossier and connected its decision back into the
five-candidate dossier index.

## Files

- `research/tracks/A-lineage/A.1b+minimum-postal-parish/sections/66-alum-bridge-truth-dossier.md`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/alum-bridge-truth-dossier-source-review-2026-08-16.csv`
- `research/tracks/A-lineage/A.1b+minimum-postal-parish/tables/alum-bridge-truth-dossier-decision-2026-08-16.csv`
...
`not_yet_truth_dossier_reviewed=2`,
...
Alum Bridge is the cleanest strict sampled target-box survivor so far, with a
current inside-box postal anchor and no reviewed nearby-service constraint
observed.

## Boundary

The pulse reviews Alum Bridge only. It does not prove complete service absence,
